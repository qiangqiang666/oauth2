...
import com.traffic.authentication.oauth2.exception.OauthException;
...
public class OauthWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        ase = (IllegalStateException) throwableAnalyzer
                .getFirstThrowableOfType(IllegalStateException.class, causeChain);
        if (ase instanceof IllegalStateException) {
            return handleOAuth2Exception(new MethodNotAllowed(ase.getMessage(), ase));
        }
        ase = (ApiException) throwableAnalyzer
                .getFirstThrowableOfType(ApiException.class, causeChain);
        if (ase instanceof ApiException) {
            return handleOAuth2Exception(new MethodNotAllowed(ase.getMessage(), ase));
        }
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
        ...
        OauthException exception = new OauthException(e.getMessage(), e);
